                ...
                >
                    <article className="flex flex-col pl-4 md:pl-12 items-start w-full poppins-font">
                        ...
                        <div className='__some-buttons absolute w-full bottom-0 z-10'>
                            ...
                            <Reveal>
                                <div className="social-buttons bg-[#f2f2f2] shadow-lg px-2.5 py-4 rounded-full dark:bg-[#1F1F1F] flex justify-center items-center absolute bottom-5 -left-3" id="CorSocial">
                    ...
                    <Reveal>
                        <aside
                            ...
                            <img className="object-cover rounded-full w-[70%]" src={myselfImage} alt="Profile" />
                        </aside>
                    </Reveal>
                </section>
                            ...
                            <div className='__content max-sm:block flex justify-around items-stretch flex-row w-full h-full text-black'>
                                ...
                                <Reveal>
                                    <div className='__column pb-4 flex max-sm:pt-8 flex-col border-solid justify-center h-full w-full items-center gap-3 sm:border-l sm:border-r max-sm:border-b max-sm:border-t max-sm:mt-6 max-sm:mb-6 border-gray-300 dark:border-gray-700'>
                                        ...
                                        <div className='flex flex-col poppins-font items-center justify-center'>
                                            <h2 className='text-xl max-md:text-lg  mb-8 font-bold text-center dark:text-white select-none'>FullStack Developer</h2>
                                        ...
                                        <div className='poppins-font mb-28 max-sm:mb-10 flex flex-col items-center justify-center'>
                                            ...
                                            <p className='text-base font-medium dark:text-white text-center' translate='no'>React, Next.js, TailwindCSS, NodeJS, Python, Shadcn/ui</p>
                                        </div>
