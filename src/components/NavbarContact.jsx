                ...
                <div className='__darkmode-button mr-8 max-[400px]:mr-4 flex flex-row'>
                    ...
                    <div className='__darkmode- md:mr-4 hidden sm:flex flex-row'>
                                ...
                                <label className="switch text-sm font-medium cursor-pointer btn-color-mode-switch poppins-font inline-block m-0 relative" id="light">
                                    <input value="1" className="w-12 h-6 opacity-0 absolute top-0 m-0 cursor-pointer" id="color_mode" name="color_mode" type="checkbox"  checked={darkMode} />

                                    <label className={`btn-color-mode-switch-inner overflow-hidden m-0 w-36 h-8 relative block cursor-pointer before:content-['Dark'] after:content-['Light'] `} onClick={() => setDarkMode(!darkMode)} htmlFor="color_mode"></label>
