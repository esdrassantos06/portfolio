...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="navbar max-sm:w-1/3  flex flex-row p-10 transition-all ease-in duration-150 bg-mist-gray dark:bg-custom-black justify-between gap-10">
                <div className='flex flex-row items-center'>
                    <a href='#' translate="no" className='text-mypurple inter md:mr-10 md:ml-10 text-xl font-medium'>Es<span className='text-gray-800 dark:text-white'>dras</span></a>
                ...
                <div className='flex flex-row gap-2 items-center justify-center'>
                    ...
                    <div className='__darkmode-button md:mr-8 mr-4 flex flex-row'>
                        ...
                        <svg viewBox="0 0 16 16" className="bi bi-moon-stars-fill max-sm:ml-1 ml-2" fill="currentColor" width="20" xmlns="http://www.w3.org/2000/svg">
            ...
            {isOpen && (
                <ul className={`transition-transform duration-300 mt-0 ease-in-out ${isOpen ? 'translate-y-0' : '-translate-y-full'} flex flex-col bg-custom-black bg-opacity-40 backdrop-blur-md gap-10 pt-4 pb-4 font-medium poppins-font text-xl justify-center items-center`}>
    <li>
        <a translate="no" className={`relative text-md ${activeSection === 'home' ? 'text-mypurple' : 'text-white' } group`} href="#home">Home</a>
    </li>
    <li>
        <a translate="no" className={`relative text-md ${activeSection === 'about' ? 'text-mypurple' : 'text-white'} group`} href="#about">About</a>
    </li>
    <li>
        <a translate="no" className={`relative text-md ${activeSection === 'skills' ? 'text-mypurple' :  'text-white'} group`} href="#skills">Skills</a>
    </li>
    <li>
        <a translate="no" className={`relative text-md ${activeSection === 'projects' ? 'text-mypurple' : 'text-white' } group`} href="#projects">Projects</a>
    </li>
</ul>
