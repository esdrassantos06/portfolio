const Footer = () => {
    return (
        <footer className='relative select-none bottom-0'>
            <div className='container mx-auto flex flex-col gap-3 justify-center items-center py-10 text-black poppins-font dark:text-white'>
                <div>
                ...
                <div className="flex justify-center gap-6">
                    ...
                    <a href="https://www.linkedin.com/in/esdras-santos-990a15301/" target="_blank"
                        className="text-mypurple hover:text-purple-600 dark:text-white dark:hover:text-slate-400 transition duration-300">
                        <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                            <path
